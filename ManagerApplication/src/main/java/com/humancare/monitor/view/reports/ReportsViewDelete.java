package com.humancare.monitor.view.reports;
...
import com.humancare.monitor.event.DashboardEvent.ReportsCountUpdatedEvent;
...
import com.humancare.monitor.view.reports.ReportEditorDelete.PaletteItemType;
import com.humancare.monitor.view.reports.ReportEditorDelete.ReportEditorListener;
//import com.humancare.monitor.view.reports.ReportEditor.PaletteItemType;
//import com.humancare.monitor.view.reports.ReportEditor.ReportEditorListener;
...
public final class ReportsViewDelete extends TabSheet implements View, CloseHandler,
        ReportEditorListener {

    public static final String CONFIRM_DIALOG_ID = "confirm-dialog";

    public ReportsViewDelete() {
        setSizeFull();
    ...
    public void addReport(final ReportType reportType, final Object prefillData) {
        ReportEditorDelete reportEditor = new ReportEditorDelete(this);
    ...
    @Override
    public void titleChanged(final String newTitle, final ReportEditorDelete editor) {
