package com.humancare.monitor.view.transactions;
...
import com.humancare.monitor.view.DashboardViewType;
...
public final class TransactionsViewDelete extends VerticalLayout implements View {
    ...
    void createNewReportFromSelection() {
        grid.getSelectedItem().ifPresent(transaction -> {
            UI.getCurrent().getNavigator()
                    .navigateTo(DashboardViewType.STATISTICS.getViewName());
