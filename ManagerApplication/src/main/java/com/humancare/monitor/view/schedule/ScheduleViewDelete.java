package com.humancare.monitor.view.schedule;
...
import com.humancare.monitor.component.MovieDetailsWindow;
import com.humancare.monitor.domain.Movie;
...
public final class ScheduleViewDelete extends CssLayout implements View {

    private Calendar calendar;
    private final Component tray;

    public ScheduleViewDelete() {
        setSizeFull();
