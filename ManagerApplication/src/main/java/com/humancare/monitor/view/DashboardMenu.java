...
import com.humancare.monitor.event.DashboardEvent.PostViewChangeEvent;
import com.humancare.monitor.event.DashboardEvent.ProfileUpdatedEvent;
...
public final class DashboardMenu extends CustomComponent {
    ...
    private Component buildTitle() {
        Label logo = new Label("Human Monitor <strong>Dashboard</strong>",
                ContentMode.HTML);
    ...
    private Component buildMenuItems() {
        ...
        for (final DashboardViewType view : DashboardViewType.values()) {
            ...
            if (view == DashboardViewType.STATISTICS) {
                ...
                reports.setDropHandler(new DropHandler() {
                    ...
                    public void drop(final DragAndDropEvent event) {
                        UI.getCurrent().getNavigator().navigateTo(
                                DashboardViewType.STATISTICS.getViewName());
