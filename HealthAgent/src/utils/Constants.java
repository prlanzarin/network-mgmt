...
public final class Constants {
    ...
    public static final Map<String, OID> OID_S = new HashMap<String, OID>() {
        {
            put("humanCare", humanCare);
            put("hcUserInfo", hcUserInfo);
            put("hcBody", hcBody);
            put("hcEnvironment", hcEnvironment);
            put("hcSensor", hcSensor);
            put("hcNetwork", hcNetwork);
            put("usrName", usrName);
            put("usrAge", usrAge);
            put("usrGender", usrGender);
            put("usrLatitude", usrLatitude);
            put("usrLongitude", usrLongitude);
            put("usrX", usrOrientationX);
            put("usrY", usrOrientationY);
            put("usrZ", usrOrientationY);
            put("bloodPressure", bdBloodPressure);
            put("temperature", bdTemperature);
            put("heartRate", bdHeartRate);
            put("bdHeartRhythmLeadI", bdHeartRhythmLeadI);
            put("bdHeartRhythmLeadII", bdHeartRhythmLeadII);
            put("bloodGlucose", bdBloodGlucose);
            put("spo2", bdBloodOxygenSaturation);
            put("envHumidity", envHumidity);
            put("envTemperature", envTemperature);
            put("envLuminosity", envLuminosity);
            put("envOxygen", envOxygen);
            put("envAlarm", envAlarm);
            put("hcSensorNumber", hcSensorNumber);
            put("hcSensorTable", hcSensorTable);
            put("hcSensorEntry", hcSensorEntry);
            put("sensorType", sensorType);
            put("sensorLocation", sensorLocation);
            put("sensorBatteryPower", sensorBatteryPower);
            put("sensorBatteryAlert", sensorBatteryAlert);
            put("nwType", nwType);
            put("nwSpeed", nwSpeed);
